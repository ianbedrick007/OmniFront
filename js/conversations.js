...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!feed) return; // Prevent errors if not on conversations page
    ...
    async function fetchMessages() {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/api/live-messages?after_id=${lastMessageId}`, { credentials: 'include' });
